...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '1002384440044')).split()]  # For Multiple Id Use One Space Between Each.
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', '1002384440044') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
