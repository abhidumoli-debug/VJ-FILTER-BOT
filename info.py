...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002349246419'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002495894919')).split()]  # For Multiple Id Use One Space Between Each.
